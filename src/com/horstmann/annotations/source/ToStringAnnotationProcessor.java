...
@SupportedAnnotationTypes("com.horstmann.annotations.source.ToString")
...
public class ToStringAnnotationProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations,
        ...
        try {
            JavaFileObject sourceFile = processingEnv.getFiler().createSourceFile("com.horstmann.annotations.processed.ToStrings");
            try (PrintWriter out = new PrintWriter(sourceFile.openWriter())) {
                out.println("// Automatically generated by com.horstmann.annotations.source.ToStringAnnotationProcessor");
                out.println("package com.horstmann.annotations.processed;");
    ...
    private void writeToStringMethod(PrintWriter out, TypeElement te) {
        ...
        if (ann.includeName()) out.println("        result.append(\"" + te.getSimpleName() + "\");");        
